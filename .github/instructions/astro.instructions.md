...
- Define and document a `Props` interface in the frontmatter of every reusable component. The documentation should describe what each public prop controls, including optional/defaulted props.
...
- Comment why a non-obvious UI or rendering decision is needed; do not comment markup that is already self-explanatory. Keep comments current with the implementation.
