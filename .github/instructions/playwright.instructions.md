...
- Comments should explain why a non-obvious interaction or workaround is needed, not repeat the action or assertion expressed by the test. Remove stale comments when the test changes.
