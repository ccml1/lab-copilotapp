...
- Add comments only for non-obvious test setup or intent; do not narrate the assertion or repeat the test title. Keep test comments current when behavior changes.
